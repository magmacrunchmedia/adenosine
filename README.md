...
A collection of lightweight web game engines by [nagmacrunch media](https://magmacrunch.com). TypeScript and JavaScript, zero runtime dependencies, built for browsers.

Named after "Adenosine" by Texas Hold'Em Lava Dome, published by magmacrunch music

[![test](https://img.shields.io/badge/tests-546%20passing-brightgreen)](#testing)
...
- **Tested** — 546 tests across all 7 packages with strict TypeScript
